/* Populate tables */
INSERT INTO clientes (nombre, apellido, email, create_at, foto) VALUES('Edwin', 'Maravi', 'emaravi@cjavaperu.com', '2020-08-01', '');
...
INSERT INTO `users` (username, password, enabled) VALUES ('emaravi','$2a$10$QaHDul4nLH7fG0ZHApxXcOV34FqaaoU1I9oXnseeQmd2wI62G5pBm',1);
INSERT INTO `users` (username, password, enabled) VALUES ('admin','$2a$10$Q.EgVa2HvZ9R7EewaapMEugwPB7AKZqwF9D5QdVKO2c08srxk48Yi',1);
